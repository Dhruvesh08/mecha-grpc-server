...
# how to get mecha_sdk_server could be as easy as but default to a git checkout:
# SRC_URI += "crate://crates.io/mecha_sdk_server/0.1.0"
SRC_URI += "git://git@github.com/dhruveshb-mecha/mecha-sdk.git;protocol=ssh;nobranch=1;branch=mecha-base-v1.1"
SRCREV = "9a49d0733b9cdf8ab402994a3adba269c6b2532d"
S = "${WORKDIR}/git"
CARGO_SRC_DIR = "sdk_server"
PV:append = ".AUTOINC+9a49d0733b"
...
SRC_URI += " \
    ...
    crate://crates.io/wifi-ctrl/0.2.3 \
...
include mecha_sdk_server-${PV}.inc
include mecha_sdk_server.inc
